<html><head>
	...
	<div class="container sent-container">
		...
		<h2 class="download-prompt">👇 <span class="clickCount" id="clickCountID">265</span> people just tapped the button👇 </h2>
		<a class="button pulse" href="https://apps.apple.com/us/app/ask-fun/id1596550932" target="_blank">Get your own messages!</a>
		<a class="another" href="javascript:history.back()">Send another message</a>
	</div>
</body>
<script>
...
// Create database											comment this if u created te db
...
// sql to create table										comment this if u created the table
